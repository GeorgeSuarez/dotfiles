...
```json
{
  ...
  "setup": ["Butter and flour a loaf pan", "Preheat oven to 350 deg F (170 deg C)"],
  "ingredients": ["2 large (250 g) ripe bananas", "6 Tbsp (90 mL) butter"],
  "columns": [
    {
      "actions": [
        { "rows": [0, 0], "label": "mash" },
    ...
    {
      "actions": [{ "rows": [0, 1], "label": "mix until smooth" }]
    }
  ]
}
```
