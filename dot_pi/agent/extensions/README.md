...
PI_COMPACTION_MODEL=opencode-go/mimo-v2.5  # provider/model used for compaction summaries
...
PI_PROVIDER_FALLBACKS=opencode-go/mimo-v2.5,opencode-go/gpt-5.6-luna
